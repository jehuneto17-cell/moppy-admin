...
// Cliente confirma "está tudo certo" (C23) — captura o pagamento e fecha o pedido.
// A mesma lógica roda automaticamente via /api/cron/auto-confirm se o cliente não
// responder em 24h.
